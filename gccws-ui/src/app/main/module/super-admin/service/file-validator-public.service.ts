...
export class FileValidatorPublicService extends AppCrudRequestService<FileValidator> {
  ...
  constructor(
    ...
    super(http, appUtils.getPublicBaseURL() + appConstants.moduleSuperAdmin + 'file-validator');
  }
