...
export class FileService extends AppCrudRequestService<any>{
  ...
  constructor(
    ...
    super(http, appUtils.getPrivateBaseURL() + appConstants.moduleCommon + 'file');
  }
  ...
  viewImageUrl(fileName?: any): string{
    return fileName ?  this._BASE_URL + '/view/image/' + fileName : './assets/img/avatars/no-images.png';
  }
