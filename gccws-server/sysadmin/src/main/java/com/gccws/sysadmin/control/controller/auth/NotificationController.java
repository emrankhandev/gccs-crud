...
import com.gccws.sysadmin.control.service.NotificationService;
...
@AllArgsConstructor
@RestController
@RequestMapping(SYSTEM_ADMIN_END_POINT +"notification")
public class NotificationController implements BaseController<BaseResponse, NotificationModel, CommonPageableData, HttpServletRequest> {
	...
	@Override
	@PostMapping
	public BaseResponse save(@Valid @RequestBody NotificationModel body, HttpServletRequest request) {
    	try {
	...
	@Override
	@PutMapping
	public BaseResponse update(@Valid @RequestBody NotificationModel body, HttpServletRequest request) {
    	try {
	...
	@Override
	@DeleteMapping
	public BaseResponse delete(@Valid @RequestBody NotificationModel body,HttpServletRequest request) {
    	try {
